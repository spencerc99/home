// ABOUTME: Client-side utility functions for formatting, colors, and data manipulation
// ABOUTME: These are safe to import in React components and other client-side code
