...
related:
  [
    ...
    "/experiments/100posts/dancing-through-life",
  ]
---

import danceBackroom from "./dance-backroom.png";
...
<Figure src={danceBackroom} caption="*behind the scenes*" />
...
_This is the **93rd** installment in my experiment of publishing raw, lightly edited mini-essays every day towards achieving 100 public pieces. Check out the rationale and the full list [here](/experiments/100posts/)_.
