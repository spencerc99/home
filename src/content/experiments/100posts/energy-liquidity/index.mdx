...
<Figure
  src={textImage}
  caption="*a text I received today when asking for advice on what to get for someone*"
/>
...
_This is the **94th** installment in my experiment of publishing raw, lightly edited mini-essays every day towards achieving 100 public pieces. Check out the rationale and the full list [here](/experiments/100posts/)_.
