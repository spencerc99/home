...
import babySpencer from "./images/baby-spencer.png";
...
<Figure
  src={babySpencer}
  caption="*early to the denim trend, even got the smolder down*"
/>

<br />
<Figure
  src={
    "https://assets.spencerchang.me/fits-stream/2021-10-14%3ACamera+2021-10-14+at+9.11.24+AM.jpeg"
  }
  caption="*my current denim take (see more of my outfits on my [fits stream](/fits))*"
/>
...
<Figure src={naomi} caption="from Naomi’s website" />
