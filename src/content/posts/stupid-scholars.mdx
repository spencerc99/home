...
import rollercoaster from "./images/stupid-scholars/rollercoaster.jpeg";
import icebucket from "./images/stupid-scholars/icebucket.jpg";
import brightside from "./images/stupid-scholars/brightside.jpg";
import rice from "./images/stupid-scholars/rice.jpeg";

<Figure src={rollercoaster} class="fullWidth" />
...
<Figure
  src={icebucket}
  caption="even Rice’s President Leebron did the ice bucket challenge"
/>
...
<Figure
  src={brightside}
  caption="prime example of the good in the bad ([source](www.raphcomic.com))"
/>
...
<Figure src={rice} caption="gonna miss this view 😢" class="fullWidth" />
