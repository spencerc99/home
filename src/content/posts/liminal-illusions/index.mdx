...
import margarita from "./images/margarita.jpeg";
import sunrise from "./images/sunrise.jpeg";
import skies from "./images/skies.jpeg";
import club from "./images/club.jpeg";
import mirage from "./images/mirage/mirage.jpeg";
...
<Figure
  src={margarita}
  caption="*a fallen soldier stuck in a physical liminal space (hotel hallway) in the liminal city.*"
/>
...
<Figure
  src={sunrise}
  caption="*view of the sunrise after a full night through the sheen of the window cover.*"
/>
...
<Figure
  src={skies}
  caption="*The blue sky ceiling, Renaissance architecture, and river (with real rowers!) at The Venetian hotel and casino.*"
/>
...
<Figure
  src={club}
  caption="*the vibe of the* [*club*](https://spencerchang.substack.com/p/blazing-lights-39100-)"
/>
...
<Figure
  src={lobby}
  caption="*The Venetian’s lobby. Can you tell if it’s 4am or 4pm?*"
/>
