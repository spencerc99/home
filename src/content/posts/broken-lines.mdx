...
import logs from "./images/broken-lines/logs.jpg";
import unemployment from "./images/broken-lines/unemployment.png";
import spencerParallels from "./images/broken-lines/spencer-parallels.png";
import Figure from "../../components/Figure.astro";

<Figure
  src={logs}
  caption="a stack of logs on a Napa trip ([for more photos](https://www.instagram.com/spencerchang.photography/))"
/>

<blockquote>
  But in a life of activity, one free from dramatic rupture, where the progress
  of things is unbroken by catastrophe, where the skin of our thoughts is
  regularly touched by new impressions, discoveries and influences, our
  maturation comes to follow a gradient that creates the illusion of a seamless
  line. With Uncle Hmad, the young man he was at the point of his arrest and the
  man he has become seemed to exist in parallel, destined never to meet and yet
  resonating against one another like two discordant musical notes.
</blockquote>
...
<Figure
  src={unemployment}
  caption="U.S. unemployment rate over time now forming almost a straight line upwards ([source](https://tradingeconomics.com/united-states/unemployment-rate))"
/>
...
<Figure
  src={spencerParallels}
  caption="Ok I have to admit I haven’t actually made dalgona coffee (but how can I pass up the meme)"
/>
