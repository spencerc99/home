...
import classroom from "./images/student-to-teacher/classroom.jpeg";
import taiwanClass from "./images/student-to-teacher/taiwanclass.jpeg";
import frustration from "./images/student-to-teacher/frustration.gif";
import outline from "./images/student-to-teacher/outline.png";
import taiwanClass2 from "./images/student-to-teacher/taiwanclass2.jpeg";

<Figure
  src={classroom}
  caption="Photo by Mwesigwa Joel on Unsplash"
  class="fullWidth"
/>
...
<Figure src={taiwanClass} caption="our first welcome to the school" />
...
<Figure
  src={outline}
  caption="an example of the two sides of the spectrum of specificity"
/>
...
<Figure
  src={frustration}
  caption="the frustration you feel when things don’t go according to plan (ft. Sheldon from [Big Bang Theory](https://en.wikipedia.org/wiki/The_Big_Bang_Theory))"
/>

## RUNNING A CLASSROOM 101

<Figure src={taiwanClass2} caption="the classroom we taught in" />
