...
_In response to_ _[take back the future](https://reboothq.substack.com/p/manifesto)_
...
> Perhaps it was coming to the understanding that optimism is the closest thing we have to a boundless energy ー a substance that costs nothing to be produced and has only the potential to multiply when released into the world.
...
<blockquote>
  I demand a future where the magic is ours, the people's rather than just an
  elite class of wizards and faceless entities...
</blockquote>
